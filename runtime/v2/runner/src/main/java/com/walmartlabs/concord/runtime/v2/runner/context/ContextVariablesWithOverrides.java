...
public class ContextVariablesWithOverrides implements Variables {
  ...
  private ContextVariablesWithOverrides(Variables contextVariables, Variables overrides) {
  ...
  @Override
  public ContextVariablesWithOverrides copy() {
    return new ContextVariablesWithOverrides(this.contextVariables, this.overrides);
  }
}
